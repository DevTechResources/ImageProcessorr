        ...
        return (
          <div className="help-page-content">
            ...
            <p className="help-page-content-description">
              ImageProcessor es una herramienta fácil de usar para procesar múltiples imágenes. 
              Sigue esta guía paso a paso para comenzar.
            </p>
            ...
            <div className="help-page-steps-container">
              ...
              <div className="help-page-step-card">
                ...
                <div className="help-page-step-content">
                  ...
                  <p className="help-page-step-description">
                    Haz clic en "Procesar Imágenes" y espera a que termine. 
                    Después da clic en descargar y las  imágenes se descargarán automáticamente en formato PNG optimizado.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="help-page-content">
              ...
              <div className="help-page-feature-item">
                <div className="help-page-feature-icon-bg">
                 <svg xmlns="http://www.w3.org/2000/svg" width="54" height="48" fill="none" viewBox="0 0 54 48">
                    <path stroke="#141e57ff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M36 6h11.25m0 0v10m0-10L36 16m2.25 26h4.5c1.194 0 2.338-.421 3.182-1.172.844-.75 1.318-1.767 1.318-2.828m0-14v6M6.75 14v-4c0-1.06.474-2.078 1.318-2.828C8.912 6.422 10.057 6 11.25 6m0 36 9.324-8.288c.253-.225.553-.403.884-.525a3.021 3.021 0 0 1 2.084 0c.33.122.631.3.884.525L29.25 38m-9-32H27M9 22h18c1.243 0 2.25.895 2.25 2v16c0 1.105-1.007 2-2.25 2H9c-1.243 0-2.25-.895-2.25-2V24c0-1.105 1.007-2 2.25-2Z"/>
                 </svg>
                </div>
                <div>
            ...
            <div className="help-page-operation-cards">
              ...
              <div className="help-page-operation-card">
                ...
                <p className="help-page-operation-desc">
                Activa ambos switches. Primero se redimensionará y luego se  eliminará el 
                fondo, obteniendo imágenes con fondo transparente y dimensiones exactas.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="help-page-faq-list">
              <div className="help-page-faq-item">
                ...
                <div className={`help-page-faq-answer ${openFaq === 0 ? 'show' : ''}`}>
                  No hay límite establecido en la cantidad de imágenes. Puedes procesar desde una imagen hasta cientos 
                  simultáneamente. El único límite es la capacidad de tu dispositivo.
                </div>
              </div>
              <div className="help-page-faq-item">
                <button className="help-page-faq-question" onClick={() => toggleFaq(0)}>
                ...
                <div className={`help-page-faq-answer ${openFaq === 0 ? 'show' : ''}`}>
                   PNG es el formato ideal para web porque soporta transparencia (crucial para fondos eliminados), mantiene alta 
                   calidad y permite optimización avanzada. Nuestro sistema optimiza automáticamente los PNG, reduciendo su peso 
      ...
      <div className="help-page-main">
        <div className="help-page-container">
          <div className="help-page-brand">
            <h3 className="help-page-brand-title"></h3>
